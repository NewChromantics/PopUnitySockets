...
[System.Serializable]
public class UnityEvent_TcpPort : UnityEvent<int> { }

[System.Serializable]
public class UnityEvent_TcpPortError : UnityEvent<int, string> { }
...
namespace PopX
{
	...
	public class TcpServerSocket : System.IDisposable
	{
		...
		public TcpServerSocket(int Port, System.Action<byte[]> OnPacket, System.Action<int> OnListening, System.Action<string> OnCloseError)
		{
		...
		void StartRecv(Socket ClientSocket)
		{
			...
			RecvIteration(ClientSocket);
		}

		void RecvIteration(Socket ClientSocket)
		{
			...
			if ( !ClientSocket.ReceiveFromAsync(Recv))
			//if ( !Socket.ReceiveFromAsync(Recv))
			{
				OnRecv(ClientSocket, Recv);
			}
		}
		
		
		void OnAccept(object This_Socket, SocketAsyncEventArgs Args)
		{
...
public class PopTcpServer : MonoBehaviour
{
	[Header("First argument of event is port. Second is error")]
	public UnityEvent_TcpPort			OnConnecting;
	public UnityEvent_TcpPort 			OnListening;
